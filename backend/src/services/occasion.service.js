...
const FALLBACK_OCCASIONS = {
  ...
  friends: {
    ...
    preferredCategories: ["vida_nocturna", "bebidas", "musica", "surf", "playa", "tour", "comida"],
    avoidedCategories: [],
    tone: "adventure",
    zoneBoosts: [],
    placeBoosts: [],
  ...
  nightlife: {
    key: "nightlife",
    label: "Vida nocturna",
    tags: ["bares", "discotecas", "musica", "grupo"],
    preferredCategories: ["vida_nocturna", "bebidas", "musica", "comida"],
    avoidedCategories: ["familia", "bienestar"],
    tone: "adventure",
    zoneBoosts: [{ zone: "San Salvador", weight: 8 }, { zone: "El Tunco", weight: 6 }],
    placeBoosts: [],
    active: true,
  },
  romantic: {
